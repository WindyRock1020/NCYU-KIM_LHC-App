...
import 'package:ncyu_kim_lhc/testPage/workOrganization.dart';
...
class UnfavorableWorkingConditions extends StatefulWidget {
  const UnfavorableWorkingConditions({super.key});

  @override
  State<UnfavorableWorkingConditions> createState() =>
      _UnfavorableWorkingConditions();
}

class _UnfavorableWorkingConditions
    extends State<UnfavorableWorkingConditions> {
  String _joint = "幾乎不";
  ...
  Future<void> _saveUnfavorPoints() async {
    ...
    await prefs.setInt('unfavorablePoints', _unfavorablePoints);
  }
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WorkOrganization()),
                  );
                },
                child: const Text(
                  "下一步",
