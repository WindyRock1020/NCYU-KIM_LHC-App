...
import 'loadHandlingConditions.dart';

class Frequency extends StatefulWidget {
  const Frequency({super.key});
  @override
  State<Frequency> createState() => _Frequency();
}
...
class _Frequency extends State<Frequency> {
  ...
  Future<void> _saveFreqPoints() async {
    ...
    await prefs.setDouble('freqPoints', _freqPoints);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          const LinearProgressIndicator(value: 3/7,valueColor: AlwaysStoppedAnimation(Color(0xff0038ff)),backgroundColor: Color(0xffd9d9d9),minHeight: 5,),
          ProgressBar(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const LoadHandlingConditions()),
                );
              },
              child: const Text(
                "下一步",
