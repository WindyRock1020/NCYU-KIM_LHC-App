...
import '../testPage/videoRecording.dart';
import 'p2.dart';
...
class p1 extends StatefulWidget {
  ...
  @override
  State<p1> createState() => _EffectiveLoadWeight();
}

class _EffectiveLoadWeight extends State<p1> {
  ...
  final List<String> genderTexts = ["male", "female"];
